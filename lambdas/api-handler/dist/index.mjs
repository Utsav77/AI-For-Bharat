...
var require_httpAuthSchemeProvider = __commonJS({
  "node_modules/@aws-sdk/client-sfn/dist-cjs/auth/httpAuthSchemeProvider.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_package = __commonJS({
  "node_modules/@aws-sdk/client-sfn/package.json"(exports, module) {
    module.exports = {
...
var require_ruleset = __commonJS({
  "node_modules/@aws-sdk/client-sfn/dist-cjs/endpoint/ruleset.js"(exports) {
    ...
    var j5 = { [w5]: "Endpoint" };
    var k5 = { [u5]: c5, [v5]: [{ [w5]: "UseFIPS" }, true] };
    var l5 = { [u5]: c5, [v5]: [{ [w5]: "UseDualStack" }, true] };
    var m5 = {};
    var n5 = { [w5]: "Region" };
    var o5 = { [u5]: "getAttr", [v5]: [{ [w5]: g5 }, "supportsFIPS"] };
    var p5 = { [u5]: c5, [v5]: [true, { [u5]: "getAttr", [v5]: [{ [w5]: g5 }, "supportsDualStack"] }] };
    var q5 = [k5];
    var r5 = [l5];
    var s5 = [n5];
    var _data5 = { version: "1.0", parameters: { Region: h5, UseDualStack: i5, UseFIPS: i5, Endpoint: h5 }, rules: [{ conditions: [{ [u5]: b5, [v5]: [j5] }], rules: [{ conditions: q5, error: "Invalid Configuration: FIPS and custom endpoint are not supported", type: d5 }, { conditions: r5, error: "Invalid Configuration: Dualstack and custom endpoint are not supported", type: d5 }, { endpoint: { url: j5, properties: m5, headers: m5 }, type: e5 }], type: f5 }, { conditions: [{ [u5]: b5, [v5]: s5 }], rules: [{ conditions: [{ [u5]: "aws.partition", [v5]: s5, assign: g5 }], rules: [{ conditions: [k5, l5], rules: [{ conditions: [{ [u5]: c5, [v5]: [a5, o5] }, p5], rules: [{ endpoint: { url: "https://states-fips.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: m5, headers: m5 }, type: e5 }], type: f5 }, { error: "FIPS and DualStack are enabled, but this partition does not support one or both", type: d5 }], type: f5 }, { conditions: q5, rules: [{ conditions: [{ [u5]: c5, [v5]: [o5, a5] }], rules: [{ conditions: [{ [u5]: "stringEquals", [v5]: [n5, "us-gov-west-1"] }], endpoint: { url: "https://states.us-gov-west-1.amazonaws.com", properties: m5, headers: m5 }, type: e5 }, { endpoint: { url: "https://states-fips.{Region}.{PartitionResult#dnsSuffix}", properties: m5, headers: m5 }, type: e5 }], type: f5 }, { error: "FIPS is enabled but this partition does not support FIPS", type: d5 }], type: f5 }, { conditions: r5, rules: [{ conditions: [p5], rules: [{ endpoint: { url: "https://states.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: m5, headers: m5 }, type: e5 }], type: f5 }, { error: "DualStack is enabled but this partition does not support DualStack", type: d5 }], type: f5 }, { endpoint: { url: "https://states.{Region}.{PartitionResult#dnsSuffix}", properties: m5, headers: m5 }, type: e5 }], type: f5 }], type: f5 }, { error: "Invalid Configuration: Missing Region", type: d5 }] };
...
var require_SFNServiceException = __commonJS({
  "node_modules/@aws-sdk/client-sfn/dist-cjs/models/SFNServiceException.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_errors = __commonJS({
  "node_modules/@aws-sdk/client-sfn/dist-cjs/models/errors.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.ValidationException = ValidationException2;
...
var require_schemas_0 = __commonJS({
  "node_modules/@aws-sdk/client-sfn/dist-cjs/schemas/schemas_0.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var _resp = "response";
    var _ru = "running";
    var _s5 = "smithy.ts.sdk.synthetic.com.amazonaws.sfn";
    var _sC = "statusCode";
    ...
    exports.SFNServiceException$ = [-3, _s5, "SFNServiceException", 0, [], []];
    _s_registry5.registerError(exports.SFNServiceException$, SFNServiceException_1.SFNServiceException);
    var n0_registry5 = schema_1.TypeRegistry.for(n05);
    exports.ActivityAlreadyExists$ = [
      -3,
      n05,
      _AAE,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports.ActivityAlreadyExists$, errors_1.ActivityAlreadyExists);
    exports.ActivityDoesNotExist$ = [
      -3,
      n05,
      _ADNE,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports.ActivityDoesNotExist$, errors_1.ActivityDoesNotExist);
    exports.ActivityLimitExceeded$ = [
      -3,
      n05,
      _ALE,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports.ActivityLimitExceeded$, errors_1.ActivityLimitExceeded);
    ...
    n0_registry5.registerError(exports.ActivityWorkerLimitExceeded$, errors_1.ActivityWorkerLimitExceeded);
    ...
    n0_registry5.registerError(exports.ConflictException$, errors_1.ConflictException);
    exports.ExecutionAlreadyExists$ = [
      -3,
      n05,
      _EAE,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports.ExecutionAlreadyExists$, errors_1.ExecutionAlreadyExists);
    exports.ExecutionDoesNotExist$ = [
      -3,
      n05,
      _EDNE,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports.ExecutionDoesNotExist$, errors_1.ExecutionDoesNotExist);
    exports.ExecutionLimitExceeded$ = [
      -3,
      n05,
      _ELE,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports.ExecutionLimitExceeded$, errors_1.ExecutionLimitExceeded);
    exports.ExecutionNotRedrivable$ = [
      -3,
      n05,
      _ENR,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports.ExecutionNotRedrivable$, errors_1.ExecutionNotRedrivable);
    exports.InvalidArn$ = [
      -3,
      n05,
      _IA,
    ...
    n0_registry5.registerError(exports.InvalidArn$, errors_1.InvalidArn);
    exports.InvalidDefinition$ = [
      -3,
      n05,
      _ID,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports.InvalidDefinition$, errors_1.InvalidDefinition);
    exports.InvalidEncryptionConfiguration$ = [
      -3,
      n05,
      _IEC,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports.InvalidEncryptionConfiguration$, errors_1.InvalidEncryptionConfiguration);
    exports.InvalidExecutionInput$ = [
      -3,
      n05,
      _IEI,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports.InvalidExecutionInput$, errors_1.InvalidExecutionInput);
    exports.InvalidLoggingConfiguration$ = [
      -3,
      n05,
      _ILC,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports.InvalidLoggingConfiguration$, errors_1.InvalidLoggingConfiguration);
    exports.InvalidName$ = [
      -3,
      n05,
      _IN,
    ...
    n0_registry5.registerError(exports.InvalidName$, errors_1.InvalidName);
    exports.InvalidOutput$ = [
      -3,
      n05,
      _IO,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports.InvalidOutput$, errors_1.InvalidOutput);
    ...
    n0_registry5.registerError(exports.InvalidToken$, errors_1.InvalidToken);
    exports.InvalidTracingConfiguration$ = [
      -3,
      n05,
      _ITC,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports.InvalidTracingConfiguration$, errors_1.InvalidTracingConfiguration);
    ...
    n0_registry5.registerError(exports.KmsAccessDeniedException$, errors_1.KmsAccessDeniedException);
    ...
    n0_registry5.registerError(exports.KmsInvalidStateException$, errors_1.KmsInvalidStateException);
    ...
    n0_registry5.registerError(exports.KmsThrottlingException$, errors_1.KmsThrottlingException);
    exports.MissingRequiredParameter$ = [
      -3,
      n05,
      _MRP,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports.MissingRequiredParameter$, errors_1.MissingRequiredParameter);
    ...
    n0_registry5.registerError(exports.ResourceNotFound$, errors_1.ResourceNotFound);
    exports.ServiceQuotaExceededException$ = [
      -3,
      n05,
      _SQEE,
    ...
    n0_registry5.registerError(exports.ServiceQuotaExceededException$, errors_1.ServiceQuotaExceededException);
    ...
    n0_registry5.registerError(exports.StateMachineAlreadyExists$, errors_1.StateMachineAlreadyExists);
    exports.StateMachineDeleting$ = [
      -3,
      n05,
      _SMD,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports.StateMachineDeleting$, errors_1.StateMachineDeleting);
    exports.StateMachineDoesNotExist$ = [
      -3,
      n05,
      _SMDNE,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports.StateMachineDoesNotExist$, errors_1.StateMachineDoesNotExist);
    exports.StateMachineLimitExceeded$ = [
      -3,
      n05,
      _SMLE,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports.StateMachineLimitExceeded$, errors_1.StateMachineLimitExceeded);
    exports.StateMachineTypeNotSupported$ = [
      -3,
      n05,
      _SMTNS,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports.StateMachineTypeNotSupported$, errors_1.StateMachineTypeNotSupported);
    exports.TaskDoesNotExist$ = [
      -3,
      n05,
      _TDNE,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports.TaskDoesNotExist$, errors_1.TaskDoesNotExist);
    exports.TaskTimedOut$ = [
      -3,
      n05,
      _TTO,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports.TaskTimedOut$, errors_1.TaskTimedOut);
    exports.TooManyTags$ = [
      -3,
      n05,
      _TMT,
    ...
    n0_registry5.registerError(exports.TooManyTags$, errors_1.TooManyTags);
    ...
    n0_registry5.registerError(exports.ValidationException$, errors_1.ValidationException);
    exports.errorTypeRegistries = [
      _s_registry5,
      n0_registry5
    ];
    var AliasDescription = [0, n05, _AD, 8, 0];
    var ConnectorParameters = [0, n05, _CP, 8, 0];
    var Definition = [0, n05, _D, 8, 0];
    var EvaluationFailureLocation = [0, n05, _EFL, 8, 0];
    ...
    var SensitiveDataJobInput = [0, n05, _SDJI, 8, 0];
    var SensitiveError = [0, n05, _SE, 8, 0];
    var TestStateStateName = [0, n05, _TSSN, 8, 0];
    var ValidateStateMachineDefinitionCode = [0, n05, _VSMDC, 8, 0];
    var ValidateStateMachineDefinitionLocation = [0, n05, _VSMDL, 8, 0];
    var ValidateStateMachineDefinitionMessage = [0, n05, _VSMDM, 8, 0];
    var VariableName = [0, n05, _VN, 8, 0];
    var VariableValue = [0, n05, _VV, 8, 0];
    var VersionDescription = [0, n05, _VD, 8, 0];
    exports.ActivityFailedEventDetails$ = [
      3,
      n05,
      _AFED,
      0,
    ...
    exports.ActivityScheduledEventDetails$ = [
      3,
      n05,
      _ASED,
      0,
      [_re, _i, _iD, _tIS, _hIS],
      [0, [() => SensitiveData, 0], () => exports.HistoryEventExecutionDataDetails$, 1, 1],
      1
    ];
    exports.ActivityScheduleFailedEventDetails$ = [
      3,
      n05,
      _ASFED,
      0,
    ...
    exports.ActivityStartedEventDetails$ = [
      3,
      n05,
      _ASEDc,
      0,
    ...
    exports.ActivitySucceededEventDetails$ = [
      3,
      n05,
      _ASEDct,
      0,
    ...
    exports.ActivityTimedOutEventDetails$ = [
      3,
      n05,
      _ATOED,
      0,
    ...
    exports.CloudWatchEventsExecutionDataDetails$ = [
      3,
      n05,
      _CWEEDD,
      0,
    ...
    exports.CreateActivityInput$ = [
      3,
      n05,
      _CAI,
      0,
      [_n, _ta, _eC],
      [0, () => TagList, () => exports.EncryptionConfiguration$],
      1
    ];
    exports.CreateActivityOutput$ = [
      3,
      n05,
      _CAO,
      0,
    ...
    exports.CreateStateMachineAliasInput$ = [
      3,
      n05,
      _CSMAI,
      0,
    ...
    exports.CreateStateMachineAliasOutput$ = [
      3,
      n05,
      _CSMAO,
      0,
    ...
    exports.CreateStateMachineInput$ = [
      3,
      n05,
      _CSMI,
      0,
      [_n, _de, _rA, _ty, _lC, _ta, _tC, _p, _vD, _eC],
      [0, [() => Definition, 0], 0, 0, () => exports.LoggingConfiguration$, () => TagList, () => exports.TracingConfiguration$, 2, [() => VersionDescription, 0], () => exports.EncryptionConfiguration$],
      3
    ];
    exports.CreateStateMachineOutput$ = [
      3,
      n05,
      _CSMO,
      0,
    ...
    exports.DeleteStateMachineAliasInput$ = [
      3,
      n05,
      _DSMAI,
      0,
    ...
    exports.DeleteStateMachineAliasOutput$ = [
      3,
      n05,
      _DSMAO,
      0,
    ...
    exports.DeleteStateMachineInput$ = [
      3,
      n05,
      _DSMI,
      0,
    ...
    exports.DeleteStateMachineOutput$ = [
      3,
      n05,
      _DSMO,
      0,
    ...
    exports.DeleteStateMachineVersionInput$ = [
      3,
      n05,
      _DSMVI,
      0,
    ...
    exports.DeleteStateMachineVersionOutput$ = [
      3,
      n05,
      _DSMVO,
      0,
    ...
    exports.DescribeActivityOutput$ = [
      3,
      n05,
      _DAOe,
      0,
      [_aA, _n, _cD, _eC],
      [0, 0, 4, () => exports.EncryptionConfiguration$],
      3
    ];
    exports.DescribeExecutionInput$ = [
      3,
      n05,
      _DEI,
      0,
    ...
    exports.DescribeExecutionOutput$ = [
      3,
      n05,
      _DEO,
      0,
      [_eA, _sMA, _st, _sD, _n, _sDt, _i, _iD, _o, _oD, _tH, _mRA, _e5, _ca, _sMVA, _sMAA, _rCe, _rD, _rS, _rSR],
      [0, 0, 0, 4, 0, 4, [() => SensitiveData, 0], () => exports.CloudWatchEventsExecutionDataDetails$, [() => SensitiveData, 0], () => exports.CloudWatchEventsExecutionDataDetails$, 0, 0, [() => SensitiveError, 0], [() => SensitiveCause, 0], 0, 0, 1, 4, 0, [() => SensitiveData, 0]],
      4
    ];
    exports.DescribeMapRunInput$ = [
      3,
      n05,
      _DMRI,
      0,
    ...
    exports.DescribeMapRunOutput$ = [
      3,
      n05,
      _DMRO,
      0,
      [_mRA, _eA, _st, _sD, _mC, _tFP, _tFC, _iC, _eCx, _sDt, _rCe, _rD],
      [0, 0, 0, 4, 1, 1, 1, () => exports.MapRunItemCounts$, () => exports.MapRunExecutionCounts$, 4, 1, 4],
      9
    ];
    exports.DescribeStateMachineAliasInput$ = [
      3,
      n05,
      _DSMAIe,
      0,
    ...
    exports.DescribeStateMachineAliasOutput$ = [
      3,
      n05,
      _DSMAOe,
      0,
    ...
    exports.DescribeStateMachineForExecutionInput$ = [
      3,
      n05,
      _DSMFEI,
      0,
    ...
    exports.DescribeStateMachineForExecutionOutput$ = [
      3,
      n05,
      _DSMFEO,
      0,
      [_sMA, _n, _de, _rA, _uD, _lC, _tC, _mRA, _l, _rI, _eC, _vR],
      [0, 0, [() => Definition, 0], 0, 4, () => exports.LoggingConfiguration$, () => exports.TracingConfiguration$, 0, 0, 0, () => exports.EncryptionConfiguration$, [() => VariableReferences, 0]],
      5
    ];
    exports.DescribeStateMachineInput$ = [
      3,
      n05,
      _DSMIe,
      0,
    ...
    exports.DescribeStateMachineOutput$ = [
      3,
      n05,
      _DSMOe,
      0,
      [_sMA, _n, _de, _rA, _ty, _cD, _st, _lC, _tC, _l, _rI, _d, _eC, _vR],
      [0, 0, [() => Definition, 0], 0, 0, 4, 0, () => exports.LoggingConfiguration$, () => exports.TracingConfiguration$, 0, 0, [() => VersionDescription, 0], () => exports.EncryptionConfiguration$, [() => VariableReferences, 0]],
      6
    ];
    ...
    exports.EvaluationFailedEventDetails$ = [
      3,
      n05,
      _EFED,
      0,
    ...
    exports.ExecutionAbortedEventDetails$ = [
      3,
      n05,
      _EAED,
      0,
    ...
    exports.ExecutionFailedEventDetails$ = [
      3,
      n05,
      _EFEDx,
      0,
    ...
    exports.ExecutionRedrivenEventDetails$ = [
      3,
      n05,
      _ERED,
      0,
    ...
    exports.ExecutionStartedEventDetails$ = [
      3,
      n05,
      _ESED,
      0,
    ...
    exports.ExecutionSucceededEventDetails$ = [
      3,
      n05,
      _ESEDx,
      0,
    ...
    exports.ExecutionTimedOutEventDetails$ = [
      3,
      n05,
      _ETOED,
      0,
    ...
    exports.GetExecutionHistoryInput$ = [
      3,
      n05,
      _GEHI,
      0,
    ...
    exports.GetExecutionHistoryOutput$ = [
      3,
      n05,
      _GEHO,
      0,
    ...
    exports.InspectionDataResponse$ = [
      3,
      n05,
      _IDRn,
      0,
    ...
    exports.InspectionErrorDetails$ = [
      3,
      n05,
      _IED,
      0,
    ...
    exports.LambdaFunctionFailedEventDetails$ = [
      3,
      n05,
      _LFFED,
      0,
    ...
    exports.LambdaFunctionScheduledEventDetails$ = [
      3,
      n05,
      _LFSED,
      0,
      [_re, _i, _iD, _tIS, _tCa],
      [0, [() => SensitiveData, 0], () => exports.HistoryEventExecutionDataDetails$, 1, () => exports.TaskCredentials$],
      1
    ];
    exports.LambdaFunctionScheduleFailedEventDetails$ = [
      3,
      n05,
      _LFSFED,
      0,
    ...
    exports.LambdaFunctionStartFailedEventDetails$ = [
      3,
      n05,
      _LFSFEDa,
      0,
    ...
    exports.LambdaFunctionSucceededEventDetails$ = [
      3,
      n05,
      _LFSEDa,
      0,
    ...
    exports.ListStateMachineAliasesOutput$ = [
      3,
      n05,
      _LSMAO,
      0,
    ...
    exports.ListStateMachinesInput$ = [
      3,
      n05,
      _LSMI,
      0,
    ...
    exports.ListStateMachinesOutput$ = [
      3,
      n05,
      _LSMO,
      0,
    ...
    exports.ListStateMachineVersionsInput$ = [
      3,
      n05,
      _LSMVI,
      0,
    ...
    exports.ListStateMachineVersionsOutput$ = [
      3,
      n05,
      _LSMVO,
      0,
    ...
    exports.MapIterationEventDetails$ = [
      3,
      n05,
      _MIED,
      0,
    ...
    exports.MapRunFailedEventDetails$ = [
      3,
      n05,
      _MRFED,
      0,
    ...
    exports.MapRunRedrivenEventDetails$ = [
      3,
      n05,
      _MRRED,
      0,
    ...
    exports.MapStateStartedEventDetails$ = [
      3,
      n05,
      _MSSED,
      0,
    ...
    exports.PublishStateMachineVersionInput$ = [
      3,
      n05,
      _PSMVI,
      0,
    ...
    exports.PublishStateMachineVersionOutput$ = [
      3,
      n05,
      _PSMVO,
      0,
    ...
    exports.RoutingConfigurationListItem$ = [
      3,
      n05,
      _RCLI,
      0,
    ...
    exports.SendTaskHeartbeatInput$ = [
      3,
      n05,
      _STHI,
      0,
    ...
    exports.SendTaskHeartbeatOutput$ = [
      3,
      n05,
      _STHO,
      0,
    ...
    exports.StartSyncExecutionInput$ = [
      3,
      n05,
      _SSEI,
      0,
    ...
    exports.StartSyncExecutionOutput$ = [
      3,
      n05,
      _SSEO,
      0,
      [_eA, _sD, _sDt, _st, _sMA, _n, _e5, _ca, _i, _iD, _o, _oD, _tH, _bD],
      [0, 4, 4, 0, 0, 0, [() => SensitiveError, 0], [() => SensitiveCause, 0], [() => SensitiveData, 0], () => exports.CloudWatchEventsExecutionDataDetails$, [() => SensitiveData, 0], () => exports.CloudWatchEventsExecutionDataDetails$, 0, () => exports.BillingDetails$],
      4
    ];
    exports.StateEnteredEventDetails$ = [
      3,
      n05,
      _SEED,
      0,
      [_n, _i, _iD],
      [0, [() => SensitiveData, 0], () => exports.HistoryEventExecutionDataDetails$],
      1
    ];
    exports.StateExitedEventDetails$ = [
      3,
      ...
      0,
      [_n, _o, _oD, _aV, _aVD],
      [0, [() => SensitiveData, 0], () => exports.HistoryEventExecutionDataDetails$, [() => AssignedVariables, 0], () => exports.AssignedVariablesDetails$],
      1
    ];
    exports.StateMachineAliasListItem$ = [
      3,
      n05,
      _SMALI,
      0,
    ...
    exports.StateMachineVersionListItem$ = [
      3,
      n05,
      _SMVLI,
      0,
    ...
    exports.TaskFailedEventDetails$ = [
      3,
      n05,
      _TFED,
      0,
    ...
    exports.TaskScheduledEventDetails$ = [
      ...
      [0, 0, 0, [() => ConnectorParameters, 0], 1, 1, () => exports.TaskCredentials$],
      4
    ];
    exports.TaskStartedEventDetails$ = [
      3,
      n05,
      _TSEDa,
      0,
    ...
    exports.TaskStartFailedEventDetails$ = [
      3,
      n05,
      _TSFED,
      0,
    ...
    exports.TaskSubmittedEventDetails$ = [
      3,
      n05,
      _TSEDas,
      0,
      [_rT3, _re, _o, _oD],
      [0, 0, [() => SensitiveData, 0], () => exports.HistoryEventExecutionDataDetails$],
      2
    ];
    exports.TaskSucceededEventDetails$ = [
      3,
    ...
    exports.TaskTimedOutEventDetails$ = [
      3,
      n05,
      _TTOED,
      0,
    ...
    exports.TestStateConfiguration$ = [
      3,
      n05,
      _TSC,
      0,
    ...
    exports.TestStateInput$ = [
      3,
      n05,
      _TSI,
      0,
      [_de, _rA, _i, _iL, _rSe, _v, _sN, _mo, _co3, _sCt],
      [[() => Definition, 0], 0, [() => SensitiveData, 0], 0, 2, [() => SensitiveData, 0], [() => TestStateStateName, 0], [() => exports.MockInput$, 0], [() => SensitiveData, 0], [() => exports.TestStateConfiguration$, 0]],
      1
    ];
    exports.TestStateOutput$ = [
      3,
      n05,
      _TSO,
      0,
      [_o, _e5, _ca, _iDns, _nS, _st],
      [[() => SensitiveData, 0], [() => SensitiveError, 0], [() => SensitiveCause, 0], [() => exports.InspectionData$, 0], 0, 0]
    ];
    exports.TracingConfiguration$ = [
      3,
      n05,
      _TCr,
      0,
    ...
    exports.UpdateStateMachineAliasInput$ = [
      3,
      n05,
      _USMAI,
      0,
    ...
    exports.UpdateStateMachineAliasOutput$ = [
      3,
      n05,
      _USMAO,
      0,
    ...
    exports.UpdateStateMachineInput$ = [
      3,
      n05,
      _USMI,
      0,
      [_sMA, _de, _rA, _lC, _tC, _p, _vD, _eC],
      [0, [() => Definition, 0], 0, () => exports.LoggingConfiguration$, () => exports.TracingConfiguration$, 2, [() => VersionDescription, 0], () => exports.EncryptionConfiguration$],
      1
    ];
    ...
    exports.ValidateStateMachineDefinitionDiagnostic$ = [
      3,
      n05,
      _VSMDD,
      0,
    ...
    exports.ValidateStateMachineDefinitionInput$ = [
      3,
      n05,
      _VSMDI,
      0,
    ...
    exports.ValidateStateMachineDefinitionOutput$ = [
      3,
      n05,
      _VSMDO,
      0,
    ...
    exports.CreateStateMachineAlias$ = [
      9,
      n05,
      _CSMA,
      0,
    ...
    exports.DeleteStateMachineAlias$ = [
      9,
      n05,
      _DSMA,
      0,
    ...
    exports.DeleteStateMachineVersion$ = [
      9,
      n05,
      _DSMV,
      0,
    ...
    exports.DescribeStateMachineAlias$ = [
      9,
      n05,
      _DSMAe,
      0,
    ...
    exports.DescribeStateMachineForExecution$ = [
      9,
      n05,
      _DSMFE,
      0,
    ...
    exports.ListStateMachineAliases$ = [
      9,
      n05,
      _LSMA,
      0,
    ...
    exports.PublishStateMachineVersion$ = [
      9,
      n05,
      _PSMV,
      2,
    ...
    exports.UpdateStateMachineAlias$ = [
      9,
      n05,
      _USMA,
      0,
    ...
    exports.ValidateStateMachineDefinition$ = [
      9,
      n05,
      _VSMD,
      0,
...
var require_dist_cjs53 = __commonJS({
  "node_modules/@aws-sdk/client-sfn/dist-cjs/index.js"(exports) {
    ...
    var CreateActivityCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AWSStepFunctions", "CreateActivity", {}).n("SFNClient", "CreateActivityCommand").sc(schemas_0.CreateActivity$).build() {
    };
    var CreateStateMachineAliasCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    ...
    var CreateStateMachineCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AWSStepFunctions", "CreateStateMachine", {}).n("SFNClient", "CreateStateMachineCommand").sc(schemas_0.CreateStateMachine$).build() {
    };
    var DeleteActivityCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AWSStepFunctions", "DeleteActivity", {}).n("SFNClient", "DeleteActivityCommand").sc(schemas_0.DeleteActivity$).build() {
    };
    var DeleteStateMachineAliasCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    ...
    var DeleteStateMachineCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AWSStepFunctions", "DeleteStateMachine", {}).n("SFNClient", "DeleteStateMachineCommand").sc(schemas_0.DeleteStateMachine$).build() {
    };
    var DeleteStateMachineVersionCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    ...
    var DescribeActivityCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AWSStepFunctions", "DescribeActivity", {}).n("SFNClient", "DescribeActivityCommand").sc(schemas_0.DescribeActivity$).build() {
    };
    var DescribeExecutionCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AWSStepFunctions", "DescribeExecution", {}).n("SFNClient", "DescribeExecutionCommand").sc(schemas_0.DescribeExecution$).build() {
    };
    var DescribeMapRunCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AWSStepFunctions", "DescribeMapRun", {}).n("SFNClient", "DescribeMapRunCommand").sc(schemas_0.DescribeMapRun$).build() {
    };
    var DescribeStateMachineAliasCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    ...
    var DescribeStateMachineCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AWSStepFunctions", "DescribeStateMachine", {}).n("SFNClient", "DescribeStateMachineCommand").sc(schemas_0.DescribeStateMachine$).build() {
    };
    var DescribeStateMachineForExecutionCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    ...
    var GetActivityTaskCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AWSStepFunctions", "GetActivityTask", {}).n("SFNClient", "GetActivityTaskCommand").sc(schemas_0.GetActivityTask$).build() {
    };
    var GetExecutionHistoryCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AWSStepFunctions", "GetExecutionHistory", {}).n("SFNClient", "GetExecutionHistoryCommand").sc(schemas_0.GetExecutionHistory$).build() {
    };
    var ListActivitiesCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    ...
    var ListMapRunsCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AWSStepFunctions", "ListMapRuns", {}).n("SFNClient", "ListMapRunsCommand").sc(schemas_0.ListMapRuns$).build() {
    };
    var ListStateMachineAliasesCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    ...
    var ListStateMachinesCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AWSStepFunctions", "ListStateMachines", {}).n("SFNClient", "ListStateMachinesCommand").sc(schemas_0.ListStateMachines$).build() {
    };
    var ListStateMachineVersionsCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    ...
    var PublishStateMachineVersionCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    ...
    var RedriveExecutionCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AWSStepFunctions", "RedriveExecution", {}).n("SFNClient", "RedriveExecutionCommand").sc(schemas_0.RedriveExecution$).build() {
    };
    var SendTaskFailureCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AWSStepFunctions", "SendTaskFailure", {}).n("SFNClient", "SendTaskFailureCommand").sc(schemas_0.SendTaskFailure$).build() {
    };
    var SendTaskHeartbeatCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AWSStepFunctions", "SendTaskHeartbeat", {}).n("SFNClient", "SendTaskHeartbeatCommand").sc(schemas_0.SendTaskHeartbeat$).build() {
    };
    var SendTaskSuccessCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AWSStepFunctions", "SendTaskSuccess", {}).n("SFNClient", "SendTaskSuccessCommand").sc(schemas_0.SendTaskSuccess$).build() {
    };
    var StartExecutionCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AWSStepFunctions", "StartExecution", {}).n("SFNClient", "StartExecutionCommand").sc(schemas_0.StartExecution$).build() {
    };
    var StartSyncExecutionCommand2 = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AWSStepFunctions", "StartSyncExecution", {}).n("SFNClient", "StartSyncExecutionCommand").sc(schemas_0.StartSyncExecution$).build() {
    };
    var StopExecutionCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    ...
    var TestStateCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    ...
    var UpdateMapRunCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AWSStepFunctions", "UpdateMapRun", {}).n("SFNClient", "UpdateMapRunCommand").sc(schemas_0.UpdateMapRun$).build() {
    };
    var UpdateStateMachineAliasCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    ...
    var UpdateStateMachineCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("AWSStepFunctions", "UpdateStateMachine", {}).n("SFNClient", "UpdateStateMachineCommand").sc(schemas_0.UpdateStateMachine$).build() {
    };
    var ValidateStateMachineDefinitionCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    ...
    var commands5 = {
      ...
      StartSyncExecutionCommand: StartSyncExecutionCommand2,
    ...
    exports.StartSyncExecutionCommand = StartSyncExecutionCommand2;
...
var sfn = new import_client_sfn.SFNClient({ region: "ap-south-1" });
var CORS_HEADERS = {
...
var handler = async (event) => {
  ...
  try {
    ...
    if (body.text) {
      sfnInput.text = body.text;
    } else {
      sfnInput.demoMode = body.demoMode || "demo_procurement";
    }
    const result = await sfn.send(new import_client_sfn.StartSyncExecutionCommand({
